...
class StitchSchemataCommand(Command):
    ...
    options = [
        ...
        option(long_name='tile-height',
               ...
               default=200,
               flag=False),
        option(long_name='tile-fraction',
               description='The default (top or bottom) fraction of the scanned page applied when searching searching for the top and bottom tiles.',
               default=0.4,
               flag=False),
    ...
    def _create_config(self, tmp_path: Path) -> Config:
        ...
        return Config(margin=int(self.option('margin')),
                      ...
                      tile_fraction=float(self.option('tile-fraction')),
