...
class StitchSchemataCommand(Command):
    ...
    options = [option(long_name='output',
                      ...
                      flag=False),
               option(long_name='mode',
                      description="The colorspace of the output. Either: 'color', 'grayscale', or 'black-gray-white'.",
                      flag=False,
                      value_required=True,
                      default='color'),
               ...
               option(long_name='vertical-offset-max',
                      ...
                      default=200,
                      flag=False),
               option(long_name='rotation-max',
                      description='The maximum rotation offset in degrees of the scanned pages.',
                      default=1.0,
                      flag=False),
    ...
    def _create_config(self, tmp_path: Path) -> Config:
        ...
        return Config(margin=int(self.option('margin')),
                      ...
                      rotation_max=float(self.option('rotation-max')),
